...
public class Robot extends TimedRobot {
  ...
  {
    new AlignToReefTagRelative(true).schedule();
  }
...
// robot pose to target NWU Pose2d(Translation2d(X: -0.88, Y: -0.01), Rotation2d(Rads: 0.43, Deg: 24.84))
// drive speeds 0.7645168498360806, 0.5236808613287721, 0.025145024959035915
// drive speeds 0.7645168498360806, 0.5236808613287721, 0.025145024959035915
// drive speeds 0.7645168498360806, 0.5236808613287721, 0.025145024959035915
// drive speeds 0.7645168498360806, 0.5236808613287721, 0.025145024959035915
// drive speeds 0.7645168498360806, 0.5236808613287721, 0.025145024959035915
...
// drive speeds 0.7645168498360806, 0.5236808613287721, 0.025145024959035915
// robot pose to target NWU Pose2d(Translation2d(X: -0.88, Y: -0.01), Rotation2d(Rads: 0.43, Deg: 24.84))
// drive speeds 0.7653998813442664, 0.5237089516038544, 0.025149190036996505
// drive speeds 0.7653998813442664, 0.5237089516038544, 0.025149190036996505
// drive speeds 0.7653998813442664, 0.5237089516038544, 0.025149190036996505
// drive speeds 0.7653998813442664, 0.5237089516038544, 0.025149190036996505
// robot pose to target NWU Pose2d(Translation2d(X: -0.88, Y: -0.01), Rotation2d(Rads: 0.43, Deg: 24.78))
// drive speeds 0.7685360458272146, 0.5239383185594754, 0.02508556368807661
// drive speeds 0.7685360458272146, 0.5239383185594754, 0.02508556368807661
// drive speeds 0.7685360458272146, 0.5239383185594754, 0.02508556368807661
// drive speeds 0.7685360458272146, 0.5239383185594754, 0.02508556368807661
// drive speeds 0.7685360458272146, 0.5239383185594754, 0.02508556368807661
// drive speeds 0.7685360458272146, 0.5239383185594754, 0.02508556368807661
// robot pose to target NWU Pose2d(Translation2d(X: -0.88, Y: -0.01), Rotation2d(Rads: 0.43, Deg: 24.75))
// drive speeds 0.7692531724019659, 0.5233768820972263, 0.025053220216996727
// drive speeds 0.7692531724019659, 0.5233768820972263, 0.025053220216996727
// drive speeds 0.7692531724019659, 0.5233768820972263, 0.025053220216996727
// drive speeds 0.7692531724019659, 0.5233768820972263, 0.025053220216996727
// drive speeds 0.7692531724019659, 0.5233768820972263, 0.025053220216996727
// robot pose to target NWU Pose2d(Translation2d(X: -0.88, Y: -0.01), Rotation2d(Rads: 0.44, Deg: 25.00))
// drive speeds 0.7643294986056133, 0.5238607075724483, 0.025308445958684374
// drive speeds 0.7643294986056133, 0.5238607075724483, 0.025308445958684374
// drive speeds 0.7643294986056133, 0.5238607075724483, 0.025308445958684374
// drive speeds 0.7643294986056133, 0.5238607075724483, 0.025308445958684374
// drive speeds 0.7643294986056133, 0.5238607075724483, 0.025308445958684374
// robot pose to target NWU Pose2d(Translation2d(X: -0.88, Y: -0.01), Rotation2d(Rads: 0.44, Deg: 24.97))
// drive speeds 0.7672215423485609, 0.5236934900070047, 0.02527340500922279
// drive speeds 0.7672215423485609, 0.5236934900070047, 0.02527340500922279
// drive speeds 0.7672215423485609, 0.5236934900070047, 0.02527340500922279
// drive speeds 0.7672215423485609, 0.5236934900070047, 0.02527340500922279
// drive speeds 0.7672215423485609, 0.5236934900070047, 0.02527340500922279
// robot pose to target NWU Pose2d(Translation2d(X: -0.88, Y: -0.01), Rotation2d(Rads: 0.43, Deg: 24.84))
// drive speeds 0.7672755379002316, 0.5234903574517138, 0.025145036306927722
// drive speeds 0.7672755379002316, 0.5234903574517138, 0.025145036306927722
// drive speeds 0.7672755379002316, 0.5234903574517138, 0.025145036306927722
// drive speeds 0.7672755379002316, 0.5234903574517138, 0.025145036306927722
// drive speeds 0.7672755379002316, 0.5234903574517138, 0.025145036306927722
// drive speeds 0.7672755379002316, 0.5234903574517138, 0.025145036306927722
// robot pose to target NWU Pose2d(Translation2d(X: -0.88, Y: -0.01), Rotation2d(Rads: 0.43, Deg: 24.92))
// drive speeds 0.7651171370655533, 0.5236636334924918, 0.025229003059787893
// drive speeds 0.7651171370655533, 0.5236636334924918, 0.025229003059787893
// drive speeds 0.7651171370655533, 0.5236636334924918, 0.025229003059787893
// drive speeds 0.7651171370655533, 0.5236636334924918, 0.025229003059787893
// drive speeds 0.7651171370655533, 0.5236636334924918, 0.025229003059787893
// drive speeds 0.7651171370655533, 0.5236636334924918, 0.025229003059787893
// robot pose to target NWU Pose2d(Translation2d(X: -0.88, Y: -0.01), Rotation2d(Rads: 0.43, Deg: 24.87))
// drive speeds 0.76576512199666, 0.5233266864237618, 0.025179483254707997
// drive speeds 0.76576512199666, 0.5233266864237618, 0.025179483254707997
// drive speeds 0.76576512199666, 0.5233266864237618, 0.025179483254707997