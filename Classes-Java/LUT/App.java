...
public class App {
    ...
    {
        LUT conversion = new LUT(10); // construct with parameter at least as large as the number of data points; minimum of 2 points

        conversion.add(1., 100.); // enter X, Y co-ordinate data in X order ascending
